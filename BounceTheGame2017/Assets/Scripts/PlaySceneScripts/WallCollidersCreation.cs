...
public class WallCollidersCreation : MonoBehaviour {
	...
	float PixelsToUnits(float pixelNum){
	...
	Vector3 GetLeftWallPosition(){
		Vector3 leftWallPosition = new Vector3 (0,Screen.height/2, 0);
	...
	Vector3 GetRightWallPosition(){
		Vector3 rightWallPosition = new Vector3 (Screen.width,Screen.height/2, 0);
	...
	void InstantiateFloor(){
		...
		floor.size = new Vector2 (PixelsToUnits(Screen.width), 1);
	}
	...
	void InstantiateLeftWall(){
		...
		leftWall.size = new Vector2 (1, PixelsToUnits(Screen.height));
	}
	...
	void InstantiateRightWall(){
		...
		rightWall.size = new Vector2 (1, PixelsToUnits(Screen.height));
	}
